    ...
    <div className="flex min-h-screen -mb-14">
      ...
      <div className="flex-1 p-10">
        ...
        <button
          ...
          className="bg-gray-300 active:bg-gray-400 px-4 py-1 rounded cursor-pointer"
        >
          Back
        </button>
        <div className="shadow-lg px-4 py-6 rounded max-w-3xl mx-auto">
          <form className="space-y-6">
            ...
            <button onClick={handleSubmit} className="px-5 py-1.5 bg-red-600 rounded text-white cursor-pointer active:bg-red-800">Add Product</button>
          </form>
        </div>
      </div>
    </div>
