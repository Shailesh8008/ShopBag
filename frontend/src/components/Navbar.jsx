  ...
  return (
    <>
      {!path.includes("/admin/") ? (
        ...
        <nav className="bg-gradient-to-r from-purple-100 via-white to-white pt-3 pb-2 border-b border-gray-300 shadow">
          <h1 className="font-bold text-3xl text-center text-transparent bg-gradient-to-b from-gray-400 via-gray-400/90 to-gray-800 bg-clip-text min-h-10">
            Welcome to ShopBag Admin Panel
          </h1>
        </nav>
      )}
    </>
